    ...
    //Richard, Operator's Homework
{
    ...
    public class OperatorsTests
    {
        ...
        public void Modulus_Can_Be_Used_To_Check_For_Even_Numbers()
        {
            ...
            Assert.That(isEven, Is.EqualTo(0));
        }
        ...
        //    Assert.That(isOdd, Is.EqualTo(__FILL_ME_IN__));
        //}
        ...
        //    var number = 41;
        //    number?;
        //    Assert.That(number, Is.EqualTo(__FILL_ME_IN__));
        //}
        ...
        //{
        //    Assert.That(3 > 9, Is.EqualTo(__FILL_ME_IN__));
        //    Assert.That(9 > 9, Is.EqualTo(__FILL_ME_IN__));
        //    Assert.That(9 >= 9, Is.EqualTo(__FILL_ME_IN__));
        //    Assert.That(3 < 9, Is.EqualTo(__FILL_ME_IN__));
        //    Assert.That(9 < 9, Is.EqualTo(__FILL_ME_IN__));
        //    Assert.That(9 <= 9, Is.EqualTo(__FILL_ME_IN__));
